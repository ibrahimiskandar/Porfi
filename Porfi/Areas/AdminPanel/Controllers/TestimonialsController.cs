...
using Porfi.Data;
using Porfi.Models;
using Porfi.ViewModels;

namespace Porfi.Areas.AdminPanel.Controllers
{
    [Area("AdminPanel")]
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Photo,Name,Role,Comment,Star")] TestimonialCreateViewModel model)
        {
        ...
        private string UploadedFile(TestimonialCreateViewModel model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Avatar,Name,Role,Comment,Star")] Testimonial testimonial)
        {
